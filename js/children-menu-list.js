$(function () {
    ...
    layui.use(['table','form'], function(){
        ...
        table.render({
            elem: '#table',
            url: serverUrl + '/manage/menu/' + getQueryVariable("parentId") + '/children',
            where:{
                msgType: 0
            },
            headers: {
            ...
            cols:  [[
                ...
                {field: 'type', title: '按钮类型',templet: '<div>{{d.type == "parent"?"一级菜单":""}}{{d.type == "view"?"跳转网页":""}}{{d.type == "click"?"触发关键字":""}}</div>'},
